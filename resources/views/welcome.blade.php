            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                @auth
                    <a href="{{ route('dashboard') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Game
                        Room</a>
                @else
                    <a href="{{ route('login') }}"
                ...
                <!--<a href="{{ url('/terms') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Terms</a>-->
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <a href="{{ Auth::check() ? route('games.slot.classic') : route('login') }}"
                        ...
                        <div>
                            <div class="h-64 w-64 flex items-center rounded-full">
                                <img src="{{ asset('assets/logo_classic.png') }}" alt="Game 1" class="object-cover"
                                    width="300px">
                            </div>
                    ...
                    <div class="flex items-center gap-4">
                        <a href="https://www.facebook.com"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <path
                                    d="M12 0C5.373 0 0 5.373 0 12c0 6.627 5.373 12 12 12s12-5.373 12-12c0-6.627-5.373-12-12-12zm3.484 6.308c.781 0 1.413.632 1.413 1.413v2.109h-1.412v2.766h1.412v6.857h-2.981v-6.857h-1.01v-2.766h1.01V8.357c0-1.242.787-1.858 1.91-1.858z" />
                            </svg>
                            Facebook Page
                        </a>
                    </div>
